...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN) // This requires API' s 16+, while current is 15
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        // Use the getAppWidgetOptions method to get a bundle of all the information about a widget
        Bundle options = appWidgetManager.getAppWidgetOptions(appWidgetId);
        // Get the current width, to decide on single plant vs garden grid view
    ...
    private static RemoteViews getGardenGridRemoteView(Context context) {
        // Start by creating RemoteView Object with a grid layout
    ...
    // We override this so that an update occurs whenever we change the widget width
